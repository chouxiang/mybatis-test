...
import com.xzhang.date.DateOperator;
...
public class JsonUtil {
	private static String[] DATE_FORMATS = new String[] { "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm", "yyyy-MM-dd" , "yyyyMMdd" };
	...
	/**
	 * 可以用于返回单个dto类
	 * 用法：print(response,JsonUtil.array2Json(dtoList, "yyyy-MM-dd"));
	 * @param resp
	 * @param json
	 */
	public static void print(HttpServletResponse resp,String json){
